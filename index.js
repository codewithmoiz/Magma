...
document.querySelector("#page4>h1").innerHTML = clutter; // Update the innerHTML

// Now, add the animation to change the color from gray to white using GSAP and ScrollTrigger
gsap.to("main #page4>h1>span", {
  scrollTrigger: {
    trigger: "main #page4>h1>span",
    start: "top bottom",
    end: "bottom top",
    scroller: "main",
    scrub: 0.5,
...
document.querySelector("#page6>h1").innerHTML = clutter; // Update the innerHTML

// Now, add the animation to change the color from gray to white using GSAP and ScrollTrigger
gsap.to("main #page6>h1>span", {
  scrollTrigger: {
    trigger: "main #page6>h1>span",
    start: "top bottom",
    end: "bottom top",
    scroller: "main",
    scrub: 0.5,
...
gsap.from("#right9-center, #left9>h1",{
  scale: 0,
  duration: 2,
  opacity: 0,
  stagger: 0.5,
